                                ...
                                <td>
                                    <div id="search<?= $dataResult[$i]['CatalogId'];?>">
                                        <div class="row panel panel-default">
                                            <div class="col-sm-1">
                                                <!-- <?php if($page==1){echo $i+1;} else { echo ($page-1)*$limit+$i+1;}?> &nbsp; -->
                                                ...
                                                <div id="favourite<?=$dataResult[$i]['CatalogId']?>">
                                                    <?php
                                                    if (!isset($noAnggota)) {
                                                        echo "<a class='btn btn-success' href=\"javascript:void(0)\" onclick=\"tampilLogin()\"title=\"Tambah ke Favorite\">+<span class=\"glyphicon glyphicon-star\"></a>";
                                                    }
                                                    else echo"<a class='btn btn-success' onclick=\"favorite(".$dataResult[$i]['CatalogId'].")\" href=\"javascript:void(0)\"  title=\"Tambah ke Favorite\">+<span class=\"glyphicon glyphicon-star\"></a>";
                                                    ?>
                                            ...
                                            <div class="col-sm-2">
                                                <a ><img src="<?= $urlcover ?>" style="width:97px ; height:144px" ></a>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        for($x=0;$x<sizeof($dataResult[$i]['authOriginal']);$x++){
                                            if($x==0){
                                                echo"
                                                    ...
                                                    <td>
                                                        <a href=\"?action=pencarianSederhana&ruas=Pengarang&bahan=".$dataResult[$i]['worksheet_id']."&katakunci=".$dataResult[$i]['authModif'][$x]."\"> ".$dataResult[$i]['authOriginal'][$x]." </a>
                                                    </td>
                                                    </tr>";
                                            } else
                                            {
