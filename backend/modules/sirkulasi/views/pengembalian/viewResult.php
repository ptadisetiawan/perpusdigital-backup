...
$this->registerJs("
    ...
    $('#print-slip-pengembalian').click(function() {
        ...
        var url = '".Url::to(['print/cetak-slip-pengembalian','NoPinjam'=>$daftarItem[0]['CollectionLoan_id'],'for'=>$for])."';
          $('#Iframe1Slip').attr('src',url);
        });
    ...
    $('#print-struk-pengembalian').click(function() {
        ...
        var url = '".Url::to(['print/cetak-struk-pengembalian','NoPinjam'=>$daftarItem[0]['CollectionLoan_id'],'for'=>$for])."';
          $('#Iframe1Slip').attr('src',url);
        });
