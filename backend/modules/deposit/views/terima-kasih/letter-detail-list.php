...
//            'KD_PENERBIT_DTL', 
        ...
        'panel' => [
            ...
            'after'=>Html::a('<i class="glyphicon glyphicon-repeat"></i> '.Yii::t('app','Reset List'), ['index'], ['class' => 'btn btn-info']).' '.Html::a(Yii::t('app', 'Cetak Ucapan Terima Kasih'), ['cetak','id' => $model->ID], ['class' => 'btn bg-green btn-md']),
            'showFooter'=>true
        ],
    ]); Pjax::end(); ?>
